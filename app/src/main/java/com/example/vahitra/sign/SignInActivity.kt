...
import com.example.vahitra.admin.DashboardAdmin
...
//            var goHome = Intent(this@SignInActivity, DashboardAdmin::class.java)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(user == null){
                    ...
                    if(user.password.equals(iPassword)){
                        ...
                        preference.setValues("level", user.level.toString())
                        preference.setValues("status", "1")

                        if(user.level.equals("1")){
                            var intent = Intent(this@SignInActivity, HomeActivity::class.java)
                            startActivity(intent)
                        }
                        else{
                            var intent = Intent(this@SignInActivity, DashboardAdmin::class.java)
                            startActivity(intent)
                        }
                    } else {
