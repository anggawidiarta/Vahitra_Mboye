...
class PilihBangkuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_beli.setOnClickListener {
            ...
            pesan.putExtra("data", data)
            pesan.putExtra("kursi", datalist)
            startActivity(pesan)
        }
